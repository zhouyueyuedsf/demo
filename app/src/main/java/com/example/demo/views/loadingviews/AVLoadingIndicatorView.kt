...
class AVLoadingIndicatorView : View {
    private val DEFAULT_INDICATOR = BallPulseSyncIndicator()
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        mMinWidth = a.getDimensionPixelSize(R.styleable.AVLoadingIndicatorView_AvMinWidth, mMinWidth)
        mMaxWidth = a.getDimensionPixelSize(R.styleable.AVLoadingIndicatorView_AvMaxWidth, mMaxWidth)
        mMinHeight = a.getDimensionPixelSize(R.styleable.AVLoadingIndicatorView_AvMinHeight, mMinHeight)
        mMaxHeight = a.getDimensionPixelSize(R.styleable.AVLoadingIndicatorView_AvMaxHeight, mMaxHeight)
...
// shown long enough.
    ...
    private fun updateDrawableBounds(w: Int, h: Int) { // onDraw will translate the canvas so we draw starting at 0,0.
