...
public abstract class FlTransformationBehavior extends ExpandableTransformationBehavior {
  ...
  public FlTransformationBehavior() {}

  public FlTransformationBehavior(Context context, AttributeSet attrs) {
    super(context, attrs);
  }
  ...
  public boolean layoutDependsOn(CoordinatorLayout parent, View child, View dependency) {
    ...
    if (dependency instanceof ExpandRevealFrameLayout) {
      int expandedComponentIdHint =
          ((ExpandRevealFrameLayout) dependency).getExpandedComponentIdHint();
...
//    }
  ...
  private void createExpansionAnimation(
    ...
    ((ExpandRevealFrameLayout) dependency).getContentRect(tmpRect);
